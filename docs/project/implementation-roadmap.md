...
| P9.3 | Implement Actual-write application receipts and crash recovery        | Implementation/security | P2.4, P2.6, P9.2             | Agent after recovery review        | General targets, pre-call anchored intent, stable principal/action, unknown quarantine/holds, authoritative recovery, applied chain/replay |
