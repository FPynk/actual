...
export const schema = {
  ...
  receipts: {
    ...
    source_hash: f('string'),
    merchant: f('string'),
    purchase_date: f('string'),
    purchase_time: f('string'),
    currency: f('string'),
    total: f('integer'),
    subtotal: f('integer'),
    tax: f('integer'),
    tip: f('integer'),
    payment_hint: f('string'),
    line_items: f('json'),
    transcript: f('string'),
    confidence: f('json'),
    warnings: f('json'),
    ocr_revision: f('string'),
    parser_revision: f('string'),
    transcript_revision: f('integer'),
    fingerprint: f('string'),
    reviewed_at: f('string'),
    created_at: f('string'),
    updated_at: f('string'),
    tombstone: f('boolean'),
  },
